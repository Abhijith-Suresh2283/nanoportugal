  ...
  return (
    <div className="bg-gradient-to-br from-[#f7e3ff] via-[#fef3ff] to-[#f0e7ff] min-h-screen text-gray-900 overflow-x-hidden">
      <SEO
        ...
        description="Meet the distinguished speakers for the ANM 2027 Nanomaterials Conference."
        keywords="ANM 2027 speakers, nanotechnology experts, nanomaterials keynote speakers"
        path="/speakers"
      />
