  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#f7e3ff] via-[#fef3ff] to-[#f0e7ff] text-gray-900">
      <SEO 
        ...
        description="Learn about the 27-year history of the Advanced Nanomaterials Conference (ANM 2027) at the University of Aveiro, Portugal. Discover our mission to advance nanotechnology research."
          ...
          <div className="grid sm:grid-cols-3 gap-6">
            {[
              { 
                ...
                text: "Celebrate 27 years of ANM excellence in advancing nanomaterials research"
              },
              { 
