...
export default function ProjectsAndCollaboration() {
  ...
  // Name to show, respecting the submitter's "hide name" choice
  const displayName = (p) => (p.hideName ? "" : p.person);
  ...
  return (
    <div className="atlas-root min-h-screen">
      ...
      {/* ---------- masthead ---------- */}
      <section className="relative z-10 max-w-6xl mx-auto px-5 sm:px-8 pt-8 sm:pt-10 pb-12 text-center flex flex-col items-center">
        <h1
                ...
                <div className="sm:grid sm:grid-cols-[1.6fr_1fr] sm:gap-8">
                  ...
                  <div className="flex flex-col min-w-0">
                    ...
                    <h2 className="text-2xl font-light leading-snug tracking-tight mb-2">
                      {p.title || displayName(p) || "Untitled"}
                    </h2>

                    {(displayName(p) || p.affiliation) && (
                      <p className="atlas-mono text-[11px] uppercase tracking-[0.12em] mb-4" style={{ color: "var(--ink-soft)" }}>
                        {displayName(p)}{displayName(p) && p.affiliation ? " · " : ""}{p.affiliation || ""}
                      </p>
                    )}
                    ...
                    {p.email && !p.hideEmail && (
                      <a
                        href={`mailto:${p.email}`}
                        className="atlas-mono atlas-focus block text-[11px] tracking-[0.06em] mb-4 -mt-2 hover:underline break-all"
                        style={{ color: "var(--emerald)" }}
                      >
                        {p.email}
                      </a>
          ...
          >
            ...
            <div className="p-7 sm:p-9">
              ...
              <h2 className="text-2xl sm:text-3xl font-light leading-snug tracking-tight mb-1" style={{ color: "var(--ink)" }}>
                {modalProject.title || displayName(modalProject) || "Untitled"}
              </h2>
              {(displayName(modalProject) || modalProject.affiliation) && (
                <p className="atlas-mono text-[11px] uppercase tracking-[0.12em] mb-5" style={{ color: "var(--ink-soft)" }}>
                  {displayName(modalProject)}{displayName(modalProject) && modalProject.affiliation ? " · " : ""}{modalProject.affiliation || ""}
                </p>
              )}
